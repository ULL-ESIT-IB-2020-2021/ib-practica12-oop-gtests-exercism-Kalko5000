 ...
 *        a cabo con numeros complejos, especificamente, la suma y la resta (con
 *        modificacion)
 */
...
/** Modificación, con la sobrecarga de la multiplicación */

Complejo operator * (Complejo complejo1, int veces) {
  Complejo result (complejo1.getReal() * veces, complejo1.getImaginario() * veces);
  return result;
}

Complejo operator * (Complejo complejo1, double veces) {
  Complejo result (complejo1.getReal() * veces, complejo1.getImaginario() * veces);
  return result;
}